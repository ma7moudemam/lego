...
export default function ProductFilter() {
  return (
    <>
        ...
        <span id="reset-all"><a href="index.html">Reset All</a></span>
        <span id="done"><a href="index.html">Done</a></span>
    </div>
    ...
    <div class="container-filter">
        ...
        <div class="dropdown">
            <button onclick="myFunction()" class="dropbtn">
                <span>Sort by<br></br>Rating</span>
            </button>
        ...
        <section class="filter">
            <ul class="accordion-menu">
                <li>
                    ...
                    <label for="producttype">PRODUCTTYPE <i class="fas fa-chevron-down"></i></label>
                ...
                <li>
                    ...
                    <label for="age"> AGE <i class="fas fa-chevron-down"></i></label>
                    <section class="filter-content">
                ...
                <li>
                    ...
                    <label for="price"> PRICE <i class="fas fa-chevron-down"></i></label>
                    <section class="filter-content">
                ...
                <li>
                    ...
                    <label for="featured">FEATURED <i class="fas fa-chevron-down"></i></label>
                    <section class="filter-content">
                ...
                <li>
                    ...
                    <label for="availability">AVAILABILITY <i class="fas fa-chevron-down"></i></label>
                    <section class="filter-content">
                ...
                <li>
                    ...
                    <label for="rating">RATING<i class="fas fa-chevron-down"></i></label>
                    <section class="filter-content">
