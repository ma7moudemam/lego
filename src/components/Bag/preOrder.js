...
export default function PreOrder() {
	...
	return (
		<div className="border my-3 py-3 col-12 col-md-4">
			...
			<p className="m-0 f-b">$89.99</p>
			<p className="f-12 text-info">Pre-order this item today, it will ship from April 26, 2022</p>
			...
			<div className="d-flex justify-content-start align-items-center">
				<button type="button" class="btn btn-warning w-75">
					add to bag
				</button>
				<svg
					...
					height="16"
					fill="currentColor"
					class="bi bi-star-fill pointer mx-2"
					viewBox="0 0 16 16"
				>
			...
			<div className="d-flex py-3 bg-blue my-3 px-2">
				...
				<div>
					<p className="f-14 m-0 mx-2">
						A colorful Easter Chicks gift to display with LEGO® purchases over $65, available 3/25-4/16
						while supplies last.*!
					</p>
					<a className="f-12 px-2">Learn more</a>
				</div>
			</div>
		</div>
	);
