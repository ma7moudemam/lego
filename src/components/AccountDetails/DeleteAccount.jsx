				...
				<Box sx={{ bgcolor: "#f2f5f7", height: "100%" }}>
					...
					<Box sx={{ mt: 2, mx: 7 }}>
						...
						<p className="container" style={{ textAlign: "center" }}>
							You are about to delete your LEGO® Account. Everything associated with this account will be
							deleted as well, VIP points and LEGO Ideas creations included. All content you have created
							on LEGO Ideas, including contest entries, will be lost. If another user is linked to your
							LEGO Account, your linked user’s account will be reverted into default consents as defined
							in our Terms and Conditions. Do you still want to delete your LEGO Account?
						</p>
